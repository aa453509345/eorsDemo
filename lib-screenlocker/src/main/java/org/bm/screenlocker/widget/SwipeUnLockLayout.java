package org.bm.screenlocker.widget;
...
public class SwipeUnLockLayout extends FrameLayout implements View.OnTouchListener {
    /**
    ...
    public SwipeUnLockLayout(Context context, AttributeSet attrs, int defStyle) {
                    ...
                    if (isTouchOnAbsListView()) {
                        ...
                        cancelEvent
                                .setAction(MotionEvent.ACTION_CANCEL
                                        | (event.getActionIndex() << MotionEvent
